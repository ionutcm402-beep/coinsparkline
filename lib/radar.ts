...
function reason(coin:Coin,mode:RadarMode){const tier=getSignalTier(coin);const accel=coin.volatilityAccelerationPct??0;const percentile=coin.volatilityPercentile??0;const hazard=coin.flipHazardPct??0;const spark=getSparkScore(coin).score;

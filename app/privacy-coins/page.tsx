...
export default async function PrivacyCoinsPage(){
 const snapshot=await getLatestScan();
 const coins=snapshot?.coins?.length?snapshot.coins:mockCoins;
 return <div className="csl2-page"><Header/><main className="csl2-page-main"><PrivacyCoinHub coins={coins}/></main><Footer/></div>;
}

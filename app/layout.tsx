...
export default function RootLayout({children}:LayoutProps<"/">){return <html lang="en"><body><CurrencyProvider>{children}<MarketRiskWelcome/><PWARegister/><CookieConsent/></CurrencyProvider></body></html>}

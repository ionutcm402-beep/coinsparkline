...
export default function RootLayout({children}:LayoutProps<"/">){return <html lang="en" className="h-full"><body className="csl-app min-h-full flex flex-col antialiased"><CurrencyProvider><FlowingLines/>{children}<CoinPageWatchlistDock/><CookieConsent/></CurrencyProvider></body></html>}

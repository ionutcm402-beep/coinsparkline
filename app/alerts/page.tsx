...
export default function AlertsPage(){
 ...
 return <div className="min-h-screen bg-[#fbfcff] text-slate-950"><Header/><main className="mx-auto max-w-5xl px-5 py-10 sm:px-6">
  ...
  <div className="mx-auto mt-4 max-w-3xl rounded-2xl border border-amber-100 bg-amber-50 px-4 py-3"><p className="text-[11px] leading-5 text-amber-800"><strong>Delivery status:</strong> account storage and syncing are connected. Email delivery can now be tested above; automatic signal-triggered delivery is the next backend stage.</p></div>

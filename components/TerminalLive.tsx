...
export default function TerminalLive({coins,updatedLabel}:{coins:Coin[];updatedLabel?:string}){
 ...
 const detections=ranked.slice(0,7);
 ...
 return <main className="terminal-root">
  ...
  <div className="terminal-workspace">
   ...
   <TerminalChat selectedSymbol={selected?.symbol} onSelect={selectBySymbol}/>
  </div>
 </main>
}

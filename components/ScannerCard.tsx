...
export default function ScannerCard({ coin }: { coin: Coin }) {
  ...
  return (
    <Link href={`/coin/${coin.id}`} className="group rounded-[14px] border border-slate-200/70 bg-white/84 p-3 text-center shadow-[0_5px_16px_rgba(20,35,75,0.03)] transition-all hover:-translate-y-0.5 hover:border-slate-300 hover:bg-white hover:shadow-[0_10px_24px_rgba(20,35,75,0.07)]">
